...
import { ref, getDatabase, push, remove } from "firebase/database";
...
export function Room() {
  ...
  async function sendQuestion(event: FormEvent) {
    ...
    let questionsRef = ref(getDatabase(), `rooms/${roomId}/questions`);
  ...
  async function likeQuestion(questionId: string, likeId: string | undefined) {
    let likeRef = ref(getDatabase(), `rooms/${roomId}/questions/${questionId}/likes`);
    let unlikeRef = ref(getDatabase(), `rooms/${roomId}/questions/${questionId}/likes/${likeId}`);
